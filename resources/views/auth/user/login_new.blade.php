...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-indigo-100">Sistem Pengajuan HAKI Universitas Hasanuddin</p>
        </div>
        ...
        <div class="glass-effect rounded-2xl shadow-xl p-8">
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <div class="text-center space-y-3">
                    <a href="/register" class="block w-full bg-white hover:bg-gray-50 text-indigo-600 font-semibold py-3 px-4 rounded-lg border border-indigo-600 transition duration-200">
                        <i class="fas fa-user-plus mr-2"></i>Buat Akun Baru
                    </a>
                    <a href="/admin/login" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
